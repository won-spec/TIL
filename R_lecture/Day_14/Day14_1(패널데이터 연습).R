...
head(code_job_welfare$code_job)
...
welfare$religion <- ifelse(welfare$religion==1,
                           "종교있음",
                           "종교없음")
#welfare$marriage <- ifelse(welfare$marriage=="이혼",
#                           3,
#                           welfare$marriage)
...
nrow(religion_divorce)
class(religion_divorce)
head(religion_divorce)
x<-table(religion_divorce)
x
...
nrow(religion_marriage1_4)
class(religion_marriage1_4)
head(religion_marriage1_4)
